...
const ReviewerChangePwd = (props) => {
  ...
  const formHandler = () => {
    ...
    if (
      ...
      passwordMismatch
        ...
        ReviewerService.updateReviewerPassword(formData).then((res) => {
          console.log(res);
        if (res) {
          setTimeout(() => {
            setLoading(false);
  ...
  return (
    ...
    >
      ...
      Change/Create Password - Reviewer
      </DialogTitle>
      <form>
        <DialogContent>
          <DialogContentText>
          "With great power comes great responsibilities". Reviewers reviews research papers and workshop proposals and send them for admin approval.
          </DialogContentText>
          <TextField
            required
...
export default ReviewerChangePwd;
